  ...
  async generateResponse(userMessage) {
    ...
    try {
      ...
      if (netlifyRes.ok) {
        ...
        if (data.answer) {
          // Strip any code blocks if generated by LLM model
          let cleanAnswer = data.answer.replace(/```[\s\S]*?```/g, '\n*(Source code snippets are withheld. YZ.AI provides architectural and profile information only.)*\n');
          return cleanAnswer;
        }
      }
    } catch (e) {
